...
def train_model(
    ...
    # ---------------------------------------------------------------------------
    # Búsqueda de Hiperparámetros con GridSearchCV (Resolución del TODO)
    # ---------------------------------------------------------------------------
    # Nota: Como el modelo está dentro de un Pipeline bajo el nombre "model", 
    # debemos usar el prefijo "model__" para referirnos a sus parámetros.
    param_grid = {
    ...
    # Configuramos la búsqueda (cv=3 significa validación cruzada de 3 pliegues)
    grid_search = GridSearchCV(
        estimator=pipeline,
        param_grid=param_grid,
        cv=3,
        scoring="roc_auc", # Optimizamos buscando el mejor ROC AUC
    ...
    # Sobrescribimos la variable "pipeline" con el mejor pipeline encontrado
    ...
    with mlflow.start_run(run_name="Pipeline (prod)- GradientBoosting"):
        # Registra los mejores parámetros encontrados por el GridSearch
...
#
# Se ha implementado GridSearch arriba para la optimización de hiperparámetros para 
# Gradient Boosting
#####################################################################################