...
def test_train_model(tmp_path):
    # Se tiene que establecer la raíz del proyecto para acceder a los archivos de datos y métricas
    ...
    # El entrenamiento debería generar un archivo de métricas JSON junto con el modelo y el preprocesado
    ...
    assert set(metrics.keys()) == set(baseline.keys()), "Las métricas generadas no coinciden con las métri"
