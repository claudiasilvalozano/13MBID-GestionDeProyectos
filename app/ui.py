...
with st.form("prediction_form"):
    ...
    # --- AÑADIR CAMPOS QUE FALTAN EN LA UI ---
    st.divider()
    st.subheader("Indicadores Calculados")
    col9, col10 = st.columns(2)
    with col9:
        gasto_promedio_operacion = st.number_input("Gasto promedio por operación", min_value=0.0, value=27.23, format="%.2f")
    with col10:
        estabilidad_laboral = st.number_input("Índice de estabilidad laboral", min_value=0.0, max_value=1.0, value=0.23, format="%.4f")
